...
--
-- Host: localhost
-- Generation Time: Feb 17, 2018 at 02:08 AM
...
(1, '7e85bc00-0f4b-11e8-bf4b-00505695587b', 1, '', 1),
(2, 'fd08482c-137c-11e8-bf4b-00505695587b', -1, 'JucZQYMz0K/lvOMGxVWSHg==5PSd4nLIvsALoHeoqEn+iePMhZJgk+ROQYsqS1M2JsA=', 2),
(3, '91b330bd-137d-11e8-bf4b-00505695587b', -1, 'YwYQDbHsTVvMK5NkXLMWMA==lJruWvzLdsS53xPgoz363bQ+JOESom50yqN5ia8iqj0=', 3),
(4, '369ec37d-137e-11e8-bf4b-00505695587b', -1, '573orsJpS6vKT4HDSeFgSw==XCz8nudZn/1LV9uAhIH86NNim347UPWHqeaaABEm44g=', 4);
...
--
ALTER TABLE `daemons`
 ADD PRIMARY KEY (`id`), ADD UNIQUE KEY `uuid` (`uuid`), ADD KEY `idUser` (`idUser`), ADD KEY `idDaemonInfo` (`idDaemonInfo`);
...
--
ALTER TABLE `daemons`
ADD CONSTRAINT `daemons_ibfk_2` FOREIGN KEY (`idDaemonInfo`) REFERENCES `daemonInfos` (`id`),
